        ...
        (function () {
            this.jKanban = function () {
                ...
                function __buildItemCard(item) {
                    var result = 'title' in item ? `<span>${item.title}</span><i class="fas fa-trash"></i>` : '';
                    ...
                    if (self.options.itemHandleOptions.enabled) {
                        if ((self.options.itemHandleOptions.customHandler || undefined) === undefined) {
                            ...
                            result = '<div class=\'item_handle ' + customCssHandler + '\'><i class=\'item_handle ' + customCssIconHandler + '\'></i></div><div>' + result + ' <i class="fas fa-trash"></i></div>'
                        } else {
